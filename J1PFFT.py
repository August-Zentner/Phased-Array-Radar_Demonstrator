...
sdr.tx_hardwaregain_chan1 = int(-89.75)
...
for i in range(1):
    ...
    for phase_delay in delay_phases:   
        ...
        # Clear the plot before drawing the new one
        plt.clf()
        ...
        plt.text(-1, -20, "angle = {:.2g} deg".format(calcTheta(phase_delay)))
        plt.draw()
        plt.pause(0.1)  # Make the plot non-blocking
        #plt.show()
